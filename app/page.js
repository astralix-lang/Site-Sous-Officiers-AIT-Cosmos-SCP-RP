...
function PortalSectionHeaderIcon({ section }) {
  const item = PORTAL_SECTION_REGISTRY.find((entry) => entry.id === section);
  const Icon = item?.icon || TRANSMISSION_TYPES[section]?.icon || (section === "home" ? Home : Send);
  return <span className="section-category-icon" aria-hidden="true"><Icon size={24} strokeWidth={1.9} /></span>;
}
    ...
    <div className="app-shell">
      ...
      <main className="content">
        ...
        <div className="section-heading">
          <PortalSectionHeaderIcon section={activeSection} />
